...
const features = [
  ...
  { icon: TrendingDown,title: 'Energy Savings',          desc: 'Identify 2–20% reduction in electrical power — actual saving depends on your compressor and dataset.', color: 'yellow' },
